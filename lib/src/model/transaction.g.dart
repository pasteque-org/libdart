...
_Transaction _$TransactionFromJson(Map<String, dynamic> json) => _Transaction(
  address: _$JsonConverterFromJson<String, Address>(
    json['address'],
    const AddressJsonConverter().fromJson,
  ),
  balance:
      json['balance'] == null
          ? null
  ...
  crossValidationStamps:
      (json['crossValidationStamps'] as List<dynamic>?)
          ?.map((e) => CrossValidationStamp.fromJson(e as Map<String, dynamic>))
          .toList() ??
      const [],
  data:
      json['data'] == null
...
Map<String, dynamic> _$TransactionToJson(_Transaction instance) =>
    <String, dynamic>{
      'address': _$JsonConverterToJson<String, Address>(
        instance.address,
        const AddressJsonConverter().toJson,
      ),
